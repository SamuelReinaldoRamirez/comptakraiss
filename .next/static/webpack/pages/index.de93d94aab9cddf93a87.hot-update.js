...
function DataTableExample(data) {
  ...
  function initRows(data) {
    ...
    rows.forEach(function (part, index) {
      ...
      nomPrenomCustomer == null ? null : (part.splice(2, 1), part[2] = part[4], part.splice(4, 1));
